defmodule PictureWhisperWeb.UserSettingsLive do
        ...
        >
          ...
          <:actions>
            ...
            <%= if @current_user.openai_api_key do %>
              <.button type="button" phx-click="delete_api_key" class="ml-2">Delete API Key</.button>
            <% end %>
          </:actions>
        </.simple_form>
      </div>
  ...
  def handle_event("delete_api_key", _params, socket) do
    user = socket.assigns.current_user
